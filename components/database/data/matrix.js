...
class MatrixTable extends LyraComponent {
    static requires() {
        return {
     ...
     * @param {Database} task - an active database transaction, or null
    ...
    async create(db, dataset) {
        ...
        this.logger.log('Created matrix table.');
    }
